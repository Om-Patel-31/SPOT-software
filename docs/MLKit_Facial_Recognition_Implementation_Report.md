# Facial Recognition Implementation Report for SPOT real-time recognition
...
Current workflow: [src/spot/realtime.py](../src/spot/realtime.py), launched with `python main.py realtime`.
...
Target file: [src/spot/realtime.py](../src/spot/realtime.py)
