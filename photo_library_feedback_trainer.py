...
- Updates models/face_identities.json with new templates from feedback.
- Recalibrates per-label thresholds from updated templates.

Usage:
    python photo_library_feedback_trainer.py
    python photo_library_feedback_trainer.py --library "C:/Users/om31d/Downloads/Photos-3-001"
    python photo_library_feedback_trainer.py --identities models/face_identities.json
"""
...
def main() -> int:
    ...
    print("Tip: run calibrate_far_frr.py --apply after larger review sessions.")
    return 0
