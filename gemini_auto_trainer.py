...
class GeminiAutoTrainer:
    ...
    def __init__(
        ...
        self.identities_path = identities_path or Path(__file__).resolve().parent / "models" / "face_identities.json"
        ...
        self.audit_log_path = audit_log_path or Path(__file__).resolve().parent / "models" / "auto_training_audit.log"
